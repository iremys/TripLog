...
import static com.iremys.triplog.core.util.StaticValue.REQUEST_CODE_EDIT_WITHROW_GALLERY_POPUP;
import static com.iremys.triplog.core.util.StaticValue.REQUEST_CODE_EDIT_WITHROW_IMGVIEWER_POPUP;
import static com.iremys.triplog.core.util.StaticValue.REQUEST_CODE_EDIT_WITHROW_MAP_POPUP;
import static com.iremys.triplog.core.util.StaticValue.REQUEST_CODE_EDIT_WITHROW_UNIT_POPUP_M;
import static com.iremys.triplog.core.util.StaticValue.REQUEST_CODE_EDIT_WITHROW_UNIT_POPUP_P;

public class InoutEditWithrowActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    //삭제버튼
    private Button btnWithrowDel;

    //저장버튼
    private Button btnWithrowEdit;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.inout_edit_withrow_activity);
        ...
        //입출금타입 출력
        if("WITHROW".equals(inoutVo.getInoutType())){
        ...
        gvImglist.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(InoutEditWithrowActivity.this, InoutImageViewerActivity.class);
                intent.putExtra("uri", uri);
                intent.putExtra("index", position);
                startActivityForResult(intent, REQUEST_CODE_EDIT_WITHROW_IMGVIEWER_POPUP);
            }
        });
        ...
        ///////////////////////////////////////////////////////////////////////////////
        //저장버튼//////////////////////////////////////////////////////////////////////////
        btnWithrowEdit = (Button) findViewById(R.id.btnWithrowEdit);

        btnWithrowEdit.setOnClickListener(this);

        ///////////////////////////////////////////////////////////////////////////////
        //삭제버튼//////////////////////////////////////////////////////////////////////////
        btnWithrowDel = (Button) findViewById(R.id.btnWithrowDel);

        btnWithrowDel.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tvSelectMUnit: //화폐팝업 마이너스
                ...
                startActivityForResult(intent, REQUEST_CODE_EDIT_WITHROW_UNIT_POPUP_M);
                break;

            case R.id.tvSelectPUnit: //화폐팝업 플러스
                Log.d("madoo ", "화폐단위 선택 클릭");
                intent = new Intent(this, InoutUnitActivity.class);
                startActivityForResult(intent, REQUEST_CODE_EDIT_WITHROW_UNIT_POPUP_P);
                break;
            ...
            case R.id.llGoMap: //지도팝업 호출
                ...
                startActivityForResult(intent, REQUEST_CODE_EDIT_WITHROW_MAP_POPUP);
                break;
            ...
            case R.id.tvGoGallery: //갤러리팝업 호출
                ...
                startActivityForResult(intent, REQUEST_CODE_EDIT_WITHROW_GALLERY_POPUP);
                break;


            case R.id.btnWithrowEdit: //인출등록 수정 버튼 클릭
                Log.d("madoo ", "인출등록 수정 버튼 클릭");
                //수정값 정리///////////////////////////////////////////////////
            ...
            case R.id.btnWithrowDel: //수입등록 삭제 버튼 클릭
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case REQUEST_CODE_EDIT_WITHROW_UNIT_POPUP_M: //화폐팝업 결과 마이너스
            ...
            case REQUEST_CODE_EDIT_WITHROW_UNIT_POPUP_P: //화폐팝업 결과 플러스
                if (resultCode == RESULT_OK) {
                    Log.d("madoo ", "성공");
            ...
            case REQUEST_CODE_EDIT_WITHROW_MAP_POPUP: //지도팝업 결과
                if (resultCode == RESULT_OK) {
                    Log.d("madoo ", "성공");
            ...
            case REQUEST_CODE_EDIT_WITHROW_GALLERY_POPUP: //갤러리팝업 결과 사진선택
                if (resultCode == RESULT_OK) {
                    Log.d("madoo ", "성공");
                    try {
            ...
            case REQUEST_CODE_EDIT_WITHROW_IMGVIEWER_POPUP: //이미지뷰어-->삭제
                if (resultCode == RESULT_OK) {
                    Log.d("madoo ", "성공");
