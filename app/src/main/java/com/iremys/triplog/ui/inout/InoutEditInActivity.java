...
import static com.iremys.triplog.core.util.StaticValue.REQUEST_CODE_EDIT_IN_CATE_POPUP;
import static com.iremys.triplog.core.util.StaticValue.REQUEST_CODE_EDIT_IN_GALLERY_POPUP;
import static com.iremys.triplog.core.util.StaticValue.REQUEST_CODE_EDIT_IN_IMGVIEWER_POPUP;
import static com.iremys.triplog.core.util.StaticValue.REQUEST_CODE_EDIT_IN_MAP_POPUP;
import static com.iremys.triplog.core.util.StaticValue.REQUEST_CODE_EDIT_IN_UNIT_POPUP;

public class InoutEditInActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    //입금방법
    private RadioGroup rgPMethod;
    private RadioButton rbtnPBank;
    private RadioButton rbtnPCash;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inout_edit_in_activity);
        ...
        ///////////////////////////////////////////////////////////////////////////////
        //입금방법//////////////////////////////////////////////////////////////////////////
        rgPMethod = (RadioGroup) findViewById(R.id.rgPMethod);
        rbtnPBank = (RadioButton) findViewById(R.id.rbtnPBank);
        rbtnPCash = (RadioButton) findViewById(R.id.rbtnPCash);

        if("BANK".equals(inoutVo.getpMethod())){
            rgPMethod.check(rbtnPBank.getId());
        }else if("CASH".equals(inoutVo.getpMethod())){
            rgPMethod.check(rbtnPCash.getId());
        }else {
            Log.d("madoo ", "수입수정  입금방법 오류");
        }
        ...
        gvImglist.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(InoutEditInActivity.this, InoutImageViewerActivity.class);
                intent.putExtra("uri", uri);
                intent.putExtra("index", position);
                startActivityForResult(intent, REQUEST_CODE_EDIT_IN_IMGVIEWER_POPUP);
            }
        });
        ...
        ///////////////////////////////////////////////////////////////////////////////
        //저장버튼//////////////////////////////////////////////////////////////////////////
        btnInEdit = (Button) findViewById(R.id.btnInEdit);

        btnInEdit.setOnClickListener(this);


        ///////////////////////////////////////////////////////////////////////////////
        //삭제버튼//////////////////////////////////////////////////////////////////////////
        btnInDel = (Button) findViewById(R.id.btnInDel);

        btnInDel.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tvSelectPUnit: //화폐팝업
                Log.d("madoo ", "화폐단위 선택 클릭");
                intent = new Intent(this, InoutUnitActivity.class);
                startActivityForResult(intent, REQUEST_CODE_EDIT_IN_UNIT_POPUP);
                break;
            ...
            case R.id.tvSelectCate:  //카테고리팝업
                ...
                intent.putExtra("inoutType", "IN");
                startActivityForResult(intent, REQUEST_CODE_EDIT_IN_CATE_POPUP);
                break;
            ...
            case R.id.llGoMap: //지도팝업 호출
                ...
                startActivityForResult(intent, REQUEST_CODE_EDIT_IN_MAP_POPUP);
                break;
            ...
            case R.id.tvGoGallery: //갤러리팝업 호출
                ...
                startActivityForResult(intent, REQUEST_CODE_EDIT_IN_GALLERY_POPUP);
                break;


            case R.id.btnInEdit: //수입등록 수정 버튼 클릭
                Log.d("madoo ", "수입등록 수정 버튼 클릭");
                //수정값 정리///////////////////////////////////////////////////
                ...
                //입금방법
                RadioButton rb = (RadioButton) findViewById(rgPMethod.getCheckedRadioButtonId());
                if("통장".equals(rb.getText().toString())){
                    inoutVo.setpMethod("BANK");
                }else if("현금".equals(rb.getText().toString())){
                    inoutVo.setpMethod("CASH");
                }
                ...
                //카테고리
                if(cateVo != null) { //선택을 안하면 기존값 그대로
                ...
                //글수정
                Log.d("madoo ", "수정된 inout in" + inoutVo.toString());
            ...
            case R.id.btnInDel: //수입등록 삭제 버튼 클릭
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case REQUEST_CODE_EDIT_IN_UNIT_POPUP: //화폐팝업 결과
            ...
            case REQUEST_CODE_EDIT_IN_CATE_POPUP: //카테고리팝업 결과
                if (resultCode == RESULT_OK) {
                    Log.d("madoo ", "성공");
            ...
            case REQUEST_CODE_EDIT_IN_MAP_POPUP: //지도팝업 결과
                if (resultCode == RESULT_OK) {
                    Log.d("madoo ", "성공");
            ...
            case REQUEST_CODE_EDIT_IN_GALLERY_POPUP: //갤러리팝업 결과 사진선택
                if (resultCode == RESULT_OK) {
                    Log.d("madoo ", "성공");
                    try {
            ...
            case REQUEST_CODE_EDIT_IN_IMGVIEWER_POPUP: //이미지뷰어-->삭제
                if (resultCode == RESULT_OK) {
                    Log.d("madoo ", "성공");
